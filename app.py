...
def create_billing_excel(client_name, inv_df, csv_df, month_label):
    ...
    for i, acc_id in enumerate(account_order):
        ...
        for j, r in grp.iterrows():
            ...
            values = [acc_name if j == 0 else '', r.get('キャンペーン名',''), r.get('キャンペーン開始日',''), r.get('キャンペーン終了日 (指定した日付)',''), r.get('キャンペーンステータス',''), int(camp_fee), '']
...
month_options = {
    ...
    "2026年5月": ("2026-05-01", "Indeed_2026年5月.xlsx"),
    "2026年6月": ("2026-06-01", "Indeed_2026年6月.xlsx"),
    "2026年7月": ("2026-07-01", "Indeed_2026年7月.xlsx"),
    "2026年8月": ("2026-08-01", "Indeed_2026年8月.xlsx"),
}
